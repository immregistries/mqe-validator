...
public class Vaccination implements Skippable, Serializable
{
  ...
  private List<CodedEntity> adminCodeList = new ArrayList<CodedEntity>();
  
  private final CodedEntity adminNdc = new CodedEntity(CodeTable.Type.VACCINATION_NDC_CODE);
  ...
  public void setInformationSource(CodedEntity ce)
  {
  ...
  public void setOrderControl(CodedEntity ce)
  {
 ...
 * @return the adminNdc
 */
public CodedEntity getAdminNdc() {
	return adminNdc;
}
 ...
 */
public List<CodedEntity> getAdminCodeList() {
 ...
 */
public void setAdminCodeList(List<CodedEntity> adminCodeList) {
