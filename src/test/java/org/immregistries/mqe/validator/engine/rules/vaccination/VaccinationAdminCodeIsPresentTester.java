...
public class VaccinationAdminCodeIsPresentTester {

  private VaccinationAdminCodeIsPresent rule = new VaccinationAdminCodeIsPresent();
  ...
  public void testRuleNullType() {
    ...
    assertEquals(Detection.VaccinationAdminCodeIsMissing,
   ...
   */
  @Test
  public void testRuleValidValueTenCVX() {
    v.setAdminCvxCode("141");
    ValidationRuleResult r = rule.executeRule(v, mr);
    logger.warn("Detections: " + r.getValidationDetections().toString());
    assertEquals(0, r.getValidationDetections().size());
