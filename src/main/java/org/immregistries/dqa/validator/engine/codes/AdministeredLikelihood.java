...
public enum AdministeredLikelihood {
	...
	public int administeredLiklihoodScore(DqaVaccination vaccination, DqaMessageReceived message) {
	      ...
	      if (!StringUtils.isBlank(vaccination.getAmount()) && !vaccination.getAmount().equals("999") && !vaccination.getAmount().equals("0"))
	      {
	        administeredScore += 3;
	      }
	      if (!StringUtils.isBlank(vaccination.getFacilityIdNumber()) || !StringUtils.isBlank(vaccination.getFacilityName()))
	      {
	        administeredScore += 4;
	      }
	      if (vaccination.getGivenBy() != null || !StringUtils.isBlank(vaccination.getGivenByNameFirst()) || !StringUtils.isBlank(vaccination.getGivenByNameLast()))
	      {
	        administeredScore += 4;
	      }
