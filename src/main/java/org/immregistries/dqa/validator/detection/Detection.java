...
import static org.immregistries.dqa.hl7util.SeverityLevel.*;
import static org.immregistries.dqa.vxu.VxuField.*;
import static org.immregistries.dqa.validator.detection.DetectionType.*;
import static org.immregistries.dqa.validator.detection.MqeCode.*;
...
public enum Detection implements DetectionInfo {
  ...
  PatientBirthDateIsInFuture(PATIENT_BIRTH_DATE, IN_FUTURE, ERROR, MQE0116),
  ...
  PatientMiddleNameIsMissing(PATIENT_NAME_MIDDLE, MISSING, ACCEPT, MQE0169),
  PatientMiddleNameIsInvalid(PATIENT_NAME_MIDDLE, INVALID, ACCEPT, MQE0546),
  ...
  PatientNameMiddleIsInvalid(PATIENT_NAME_MIDDLE, INVALID, ERROR, MQE0528),
  PatientNameMiddleIsMissing(PATIENT_NAME_MIDDLE, MISSING, ERROR, MQE0529),
  ...
  VaccinationActionCodeIsMissing(VACCINATION_ACTION_CODE, MISSING, ACCEPT, MQE0235),
  ...
  VaccinationAdminDateIsAfterMessageSubmitted(VACCINATION_ADMIN_DATE, AFTER_MESSAGE_SUBMITTED, ACCEPT, MQE0252),
...
//  VaccinationCptCodeIsMissing(VACCINATION_CPT_CODE, MISSING, ACCEPT,  ErrorCode.MQE0303),
  ...
  static {
    for (Detection detection : Detection.values()) {
      ...
      errorCodeAttributeMap.put(detection.dqaMqeCode, detection);
    }
  }
  ...
  private MqeCode dqaMqeCode;

  Detection(VxuField fieldRef, DetectionType type, SeverityLevel severity, MqeCode dqaMqeCode) {
    this.detectionType = type;
    this.fieldRef = fieldRef;
    this.severity = severity;
    this.dqaMqeCode = dqaMqeCode;
  }
  ...
  public String getDqaMqeCode() {
    return dqaMqeCode.toString();
  }
