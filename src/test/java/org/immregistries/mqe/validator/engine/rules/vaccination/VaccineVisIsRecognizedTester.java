...
public class VaccineVisIsRecognizedTester {

  private VaccinationVisIsRecognized rule = new VaccinationVisIsRecognized();
  ...
  private static final Logger logger = LoggerFactory.getLogger(VaccineVisIsRecognizedTester.class);
