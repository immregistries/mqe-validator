...
public class ReportScorerTest {
  ...
  public MqeReportFieldDefinition generateReportFieldFirst() {
  ...
  public MqeReportFieldDefinition generateReportFieldLast() {
    MqeReportFieldDefinition def = new MqeReportFieldDefinition();
  ...
  public MqeReportFieldDefinition generateReportFieldMiddle() {
    MqeReportFieldDefinition def = new MqeReportFieldDefinition();
  ...
  public List<MqeReportFieldDefinition> getReportFieldList() {
  ...
  private MqeMessageService msgSrvc = MqeMessageService.INSTANCE;
  private MessageResponseEvaluator eval = MessageResponseEvaluator.INSTANCE;

  public MqeMessageMetrics getExampleMetrics() {
    MqeMessageServiceResponse response = msgSrvc.processMessage(this.testMessage);
  ...
  public void testWholeReport() {
    ...
    MqeMessageMetrics metrics = getExampleMetrics();
  ...
  public void testScoreField() {
    MqeReportFieldDefinition def = generateReportFieldFirst();
