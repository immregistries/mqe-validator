...
public enum IssueField {
			...
			, OBSERVATION_IDENTIFIER_CODE("identifier code", null, null)
			...
			, PATIENT_PHONE_TEL_USE_CODE("phone tel use code", null, null)
			...
			, VACCINATION_ACTION_CODE("action code", null, null)
			...
			, VACCINATION_ADMINISTERED_UNIT("administered unit", null, null)
			, VACCINATION_BODY_ROUTE("body route", null, null)
			, VACCINATION_BODY_SITE("body site", null, null)
			, VACCINATION_COMPLETION_STATUS("completion status", null, null)
			, VACCINATION_CONFIDENTIALITY_CODE("confidentiality code", null, null)
			, VACCINATION_CPT_CODE("CPT code", CodesetType.VACCINATION_CPT_CODE, null)
			, VACCINATION_CVX_CODE("CVX code", null, null)
