  ...
  public VaccinationNdcIsValid() {
    {
      ...
      id.setHowToFix("The vaccination was submitted without an NDC code. Please review how the vaccines are coded in your system and or ask your vendor to ensure that an NDC is included for all administered vaccinations. ");
    ...
    }
    {
      ...
      id.setHowToFix("The vaccination was submitted with an NDC code that was not recognized. Please review how the vaccines are coded in your system and or ask your vendor to ensure that an NDC is included for all administered vaccinations. ");
      id.setWhyToFix("Correctly understanding what type of vaccination was administered is critical for building a complete vaccination history. NDC provides the best information about the type of vaccination administered. Clinical Decision Support systems depend on having access to a complete and accurate vaccination history. Without this the recommendations for a patient will be incorrect. ");
    }
