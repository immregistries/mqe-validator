...
public class CodeHandlerTest {
	...
	public void testUseDates() {
		...
		List<ValidationIssue> list = codr.handleUseDate(codeAnthrax, adminDate, VxuField.VACCINATION_ADMIN_DATE);
		assertEquals("Shouldn't have an issue with a current date, even though it doesn't have an end date", 0, list.size());
		
		adminDate = "19650101";
		list = codr.handleUseDate(codeAnthrax, adminDate, VxuField.VACCINATION_ADMIN_DATE);
	...
	public void testAgeDates() {
		...
		List<ValidationIssue> list = codr.handleAgeDate(this.codeAdenovirus, birthDate, adminDate, VxuField.VACCINATION_ADMIN_DATE);
		...
		list = codr.handleAgeDate(this.codeAdenovirus, birthDate, adminDate, VxuField.VACCINATION_ADMIN_DATE);
		assertEquals("Should have an issue", 1, list.size());
	...
	public void testAgeDatesNull() {
		...
		List<ValidationIssue> list = codr.handleAgeDate(this.codeAdenovirus, birthDate, null, VxuField.VACCINATION_ADMIN_DATE);
		...
		list = codr.handleAgeDate(this.codeAdenovirus, null, adminDate, VxuField.VACCINATION_ADMIN_DATE);
		...
		list = codr.handleAgeDate(this.codeAdenovirus, null, null, VxuField.VACCINATION_ADMIN_DATE);
		...
		list = codr.handleAgeDate(null, null, null, VxuField.VACCINATION_ADMIN_DATE);
		assertEquals("Should not have an issue because all is null", 0, list.size());
		
		//This should NOT violate the age date because the code is null
		list = codr.handleAgeDate(null, birthDate, adminDate, VxuField.VACCINATION_ADMIN_DATE);
