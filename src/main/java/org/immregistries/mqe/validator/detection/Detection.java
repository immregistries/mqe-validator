...
//  MessageMessageDateIsInvalid(MESSAGE_DATE, INVALID, ACCEPT, MQE0016),  /* Decided this is covered by more specific detections. NB and JH */
  ...
  PatientBirthOrderAndMultipleBirthIndicatedIsMissing(PATIENT_BIRTH_ORDER, MISSING_AND_MULTIPLE_BIRTH_INDICATED, WARN, MQE0125),
  ...
  PatientBirthOrderAndMultipleBirthIndicatedIsPresent(PATIENT_BIRTH_ORDER, PRESENT, ACCEPT, MQE0657),
