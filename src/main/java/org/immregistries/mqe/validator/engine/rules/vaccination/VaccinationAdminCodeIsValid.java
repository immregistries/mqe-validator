...
public class VaccinationAdminCodeIsValid extends ValidationRule<MqeVaccination> {
  ...
  public VaccinationAdminCodeIsValid() {
    ...
    }
    {
      ...
      id.setHowToFix("The submitted code could not be recognized as a usable code. Please review how the vaccines are coded in your system and select a CVX or NDC code that better represents the vaccination given.");
    ...
    }
    {
      ...
      id.setWhyToFix("The type of vaccination administered must be indicated to record a vaccination. The sender should not report that a unknown vaccination was given. This cannot be added to an official vaccination history. ");
    }
  }
