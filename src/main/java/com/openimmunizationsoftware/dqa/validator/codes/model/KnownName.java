 ...
 */
package com.openimmunizationsoftware.dqa.validator.codes.model;
...
public class KnownName
{
  ...
  public KnownName(int knownNameId, String nameLast, String nameFirst, String nameMiddle, Date birthDate, NameType nameType) {
	super();
