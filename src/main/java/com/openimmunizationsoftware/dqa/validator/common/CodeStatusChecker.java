...
/**
 * The point of this class is to check all of the coded values against the code tables. 
 * this should represent all of the codes in the system that we are getting the status for. 
 * @author Josh
 *
 */
