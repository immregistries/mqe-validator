  ...
  public VaccinationCvxIsValid() {
    {
      ...
      id.setHowToFix("The vaccination was submitted with a CVX code that should no longer be used. Please review how vaccines are coded in your system and select a CVX code that better represents the vaccination given. ");
    ...
    }
    {
      ...
      id.setHowToFix("The vaccination was submitted without a CVX code. Please review how vaccines are coded in your system or contact your vendor to ensure that CVX codes are being submitted. ");
      id.setWhyToFix("Correctly understanding what type of vaccination was administered is critical for building a complete vaccination history. Clinical Decision Support Systems depend on having access to a complete and accurate vaccination history. Without this the recommendations for a patient will be incorrect. ");
    }
    {
      ...
      id.setHowToFix("The vaccination was submitted with a CVX code that is not recognized. Please review how vaccines are coded in your system and select a CVX code that better represents the vaccination given. ");
      id.setWhyToFix("Correctly understanding what type of vaccination was administered is critical for building a complete vaccination history. Clinical Decision Support Systems depend on having access to a complete and accurate vaccination history. Without this the recommendations for a patient will be incorrect. ");
    }
  }
