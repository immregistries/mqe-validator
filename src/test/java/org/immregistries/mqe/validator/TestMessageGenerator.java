...
public class TestMessageGenerator {
  ...
  private static final String MSH =
      "MSH|^~\\&|ECW|1337-44-01|MCIR|MDCH|20140619191115||VXU^V04|61731|P|2.3.1|||AL\r";
  private static final String PID =
      "PID|||23456^^^^MR||LASTNAME^FIRSTNAME^LEGALMIDDLE^LEGALSUFFIX^^X~COOLNAME^AWESOMENAME2|MOMSMAIDEN|20100604|M||RACECD|100 Main^^Lansing^MI^48912-1330^US^^^60~^^^^^US^BDL^^123456||^PRN^PH^^^517^555-5555~(517)555-5555^P^H||en|||||||22|23||||||DEATHDT||||||\r";
  private static final String PID2 =
      "PID|||00000^^^^MR~111111^^^^WC~22222^^^^SS~33333^^^^MA~44444^^^^SR||LEGALLAST^^^^^X~COOLNAME^AWESOMENAME2||20120605|F|||100 Main^^Lansing^MI^48912-1330^US^~^^^^^US^BDL^^123456||(517)555-2222^P^H~^PRN^PH^^^517^555-5555||en||||\r";
  private static final String NK1 =
      "NK1||NKLast^NKFirst|MTH^3^HL70063|100 Main^^Lansing^MI^48912 1330^US^|5175555555|||||||||||||||20||||||||||30|||33^^^^SS||||37|\r";
  private static final String ORC = "ORC|||123456|\r";
  private static final String RXA =
      "RXA|0||20140614|20140614|83^Hepatitis A ped/adol^CVX^90633^Hepatitis A ped/adol^CPT||||00^New immunization record^NIP001|Luginbill, David|1337-44-01^Sparrow Pediatrics (Lansing)||||J005080||MSD^Merck &Co.^MVX||||A|20140614\r";
  private static final String RXA2 =
      "RXA|0|X|20140615|20140615|87^Awesome Immunization^CVX^90633^Hepatitis A ped/adol^CPT||||00^New immunization record^NIP001|Luginbill, David|1337-44-01^Sparrow Pediatrics (Lansing)||||J005080||MSD^Merck &Co.^MVX||||A|20140614\r";
  private static final String RXA3 =
      "RXA|0||20140616|20140616|89^IMPORTANT Immunization^CVX^90633^Hepatitis A ped/adol^CPT||||00^New immunization record^NIP001|Luginbill, David|1337-44-01^Sparrow Pediatrics (Lansing)||||J005080||MSD^Merck &Co.^MVX||||A|20140614\r";
  private static final String RXR = "RXR|IM^Intramuscular^HL70162|RT^Right Thigh^HL70163\r";
  private static final String OBX =
      "OBX|2|CE|64994-7^Vaccine funding program eligibility category^LN||V02^VFC Eligible - Medicaid/Medicare^HL70064||||||F|||20140614\r";
  ...
  private final String BAD_LOT_NUMBER_EXAMPLE =
      "MSH|^~\\&||1255-60-20|MCIR|MDCH|20180912093155-0600||VXU^V04^VXU_V04|3WzJ-A.01.01.2aF|T|2.5.1\r"
          + "PID|||3WzJ-A.01.0163350623^^^AIRA-TEST^MR||Jean^Alice^^^^^L|Henry^Jim|20180601|M||2076-8^Native Hawaiian or Other Pacific Islander^HL70005|417 Bridge St NW^^Grand Rapids^MI^49544^USA^P||^PRN^PH^^^616^9245843|||||||||2135-2^Hispanic or Latino^HL70005|Birth Place PID-23\r"
          + "PD1|||||||||||02^Reminder/Recall - any method^HL70215|||||A|20170301|20170301\r"
          + "NK1|1|Jean^Jim^^^^^L|MTH^Mother^HL70063|81 Page Pl^^GR^MI^49544^USA^P|^PRN^PH^^^616^9245843\r"
          + "ORC|RE||V51L2.3^AIRA|||||||I-23432^Burden^Donna^A^^^^^NIST-AA-1||57422^RADON^NICHOLAS^^^^^^NIST-AA-1^L\r"
          + "RXA|0|1|20180901||21^Varicella^CVX|0.5|mL^milliliters^UCUM||00^Administered^NIP001||||||Y5841RR(P)||PMC^Merck and Co^MVX||||A\r"
          + "RXR|SC^^HL70162|RA^^HL70163\r"
          + "OBX|1|CE|64994-7^Vaccine funding program eligibility category^LN|1|V02^VFC eligible - Medicaid/Medicaid Managed Care^HL70064||||||F|||20170301|||VXC40^Eligibility captured at the immunization level^CDCPHINVS\r"
          ...
          + "OBX|4|TS|29769-7^Date vaccine information statement presented^LN|2|20170301||||||F\r"
          + "ORC|RE||BQ61L11032.2^AIRA|||||||I-23432^Burden^Donna^A^^^^^NIST-AA-1||57422^RADON^NICHOLAS^^^^^^NIST-AA-1^L\r"
          + "RXA|0|1|20180901||66019-0302-10^FluMist Quadrivalent^NDC|0.5|mL^milliliters^UCUM||00^Administered^NIP001||||||||MED^^MVX|||CP|A\r";
  ...
  public String getBadLotNumberExample() {
    return BAD_LOT_NUMBER_EXAMPLE;
  }
}
