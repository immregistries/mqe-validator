...
public class VaccineCollection {
  ...
  /*
   * For each message, we'll collect vaccines sent through. we're not detecting anything about the
   * codes. Just counting.
   */
  ...
  public VaccineCollection(MqeMessageReceived message) {
  ...
  private List<VaccineBucket> getVaccineBuckets(List<MqeVaccination> vaccineList, DateTime birthDate) {
