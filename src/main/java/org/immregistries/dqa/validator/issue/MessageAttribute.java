...
public enum MessageAttribute {
	...
	VaccinationProductIsMissing(IssueObject.VACCINATION, IssueType.MISSING, VxuField.VACCINATION_PRODUCT, "", SeverityLevel.ACCEPT, "101", null, ErrorCode.DQA0352, "RXA-5 or RXA-17"),
