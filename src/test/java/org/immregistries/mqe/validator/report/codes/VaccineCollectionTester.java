...
public class VaccineCollectionTester {
  ...
  public void testMerging() {
    ...
    assertEquals("cc1 - Should three shot type in this message total. ", 3,
        cc1.getCodeCountList().size());
    //assert some stuff
    VaccineCollection cc2 = new VaccineCollection(msg2);
    reportCounts(cc2, "cc2");
    assertEquals("cc2 - Should one shot type in this message total. ", 1,
        cc2.getCodeCountList().size());
    //assert some stuff
    ...
    assertEquals("cc3 - Should two shot type in this message total. ", 2,
        cc3.getCodeCountList().size());
    //assert some stuff
    VaccineCollection cc4 = new VaccineCollection(msg4);
    reportCounts(cc4, "cc4");
    assertEquals("cc4 - Should one shot type in this message total. ", 1,
        cc4.getCodeCountList().size());
    //assert some stuff
