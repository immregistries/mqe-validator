...
import com.openimmunizationsoftware.dqa.quality.batch.BatchCodeReceived;
import com.openimmunizationsoftware.dqa.quality.batch.BatchIssues;
import com.openimmunizationsoftware.dqa.quality.batch.BatchReport;
import com.openimmunizationsoftware.dqa.quality.batch.BatchType;
import com.openimmunizationsoftware.dqa.quality.batch.BatchVaccineCvx;
import com.openimmunizationsoftware.dqa.quality.batch.MessageBatch;
import com.openimmunizationsoftware.dqa.validator.issues.IssueFound;
import com.openimmunizationsoftware.dqa.validator.issues.PotentialIssue;
import com.openimmunizationsoftware.dqa.validator.issues.PotentialIssueStatus;
...
public class QualityCollector
{
  ...
  public void registerProcessedMessage(MessageReceived messageReceived)
  {
    ...
    for (Vaccination vaccination : messageReceived.getVaccinations())
    {
      ...
      {
        if (vaccination.getAdminCvx() != null && !vaccination.getAdminCvx().equals("")
            && vaccination.getAdminDate() != null)
        {
          vaccinationId = vaccination.getAdminCvx() + "-" + vaccination.getAdminDate().getTime();
        } else
        {
