  ...
  public NextOfKinRelationshipIsValidForUnderagedPatient() {
    {
      ...
      id.setWhyToFix("The relationship helps the IIS understand the reason why this person is linked to the patient and to presume the role they play in the care of the patient. IIS may use this information for patient matching and to identify the person who should be contacted for reminder/recall activities. ");
    }
    {
    ...
    }
    {
      ...
      id.setWhyToFix("Some IIS may not recognize this next-of-kin as the guardian/parent and so will not record this.");
    }
  }
