  ...
  public PatientBirthDateCharacteristic() {
    {
      ...
      id.setHowToFix(
          "There is nothing to fix if the patient was born on the first day of the month.");
      id.setWhyToFix(
          "Sometimes when the exact patient date of birth is not known the first day of the month is chosen. It is important to use the correct date of birth, both for matching purposes and determining the right time for vaccinations.");
    }
    {
      ...
      id.setHowToFix(
          "There is nothing to fix if the patient was born on the fifteenth day of the month.");
      id.setWhyToFix(
          "Sometimes when the exact patient date of birth is not known the fifteenth day of the month is chosen. It is important to use the correct date of birth, both for matching purposes and determining the right time for vaccinations.");
    }
    {
      ...
      id.setHowToFix(
          "There is nothing to fix if the patient was born on the last day of the month.");
      id.setWhyToFix(
          "Sometimes when the exact patient date of birth is not known the last day of the month is chosen. It is important to use the correct date of birth, both for matching purposes and determining the right time for vaccinations.");
    }
  }
