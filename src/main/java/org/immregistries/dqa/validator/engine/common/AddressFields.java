...
public class AddressFields {
  ...
  public AddressFields(VxuField addressRef, VxuField street, VxuField street2, VxuField city,
      VxuField state, VxuField county, VxuField country, VxuField zip, VxuField type) {
