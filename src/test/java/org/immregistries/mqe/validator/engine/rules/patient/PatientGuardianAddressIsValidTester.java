...
import org.immregistries.mqe.validator.engine.rules.patient.PatientGuardianAddressIsValid;
...
public class PatientGuardianAddressIsValidTester {

	  private PatientGuardianAddressIsValid patientGuardianAddressIsValid = new PatientGuardianAddressIsValid();
	  ...
	  private static final Logger logger = LoggerFactory.getLogger(PatientGuardianAddressIsValidTester.class);
