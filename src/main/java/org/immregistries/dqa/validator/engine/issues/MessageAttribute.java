...
public enum MessageAttribute {
	...
	PatientBirthDateIsAfterSubmission(IssueObject.PATIENT, IssueType.AFTER_SUBMISSION, IssueField.PATIENT_BIRTH_DATE, "", SeverityLevel.ACCEPT, "102", "DQA0115", "PID-7"),
	PatientBirthDateIsInFuture(IssueObject.PATIENT, IssueType.IN_FUTURE, IssueField.PATIENT_BIRTH_DATE, "", SeverityLevel.ACCEPT, "102", "DQA0116", "PID-7"),
	PatientBirthDateIsInvalid(IssueObject.PATIENT, IssueType.INVALID, IssueField.PATIENT_BIRTH_DATE, "", SeverityLevel.ACCEPT, "102", "DQA0117", "PID-7"),
	PatientBirthDateIsMissing(IssueObject.PATIENT, IssueType.MISSING, IssueField.PATIENT_BIRTH_DATE, "", SeverityLevel.ACCEPT, "101", "DQA0118", "PID-7"),
	...
	PatientBirthDateIsVeryLongAgo(IssueObject.PATIENT, IssueType.VERY_LONG_AGO, IssueField.PATIENT_BIRTH_DATE, "", SeverityLevel.ACCEPT, "102", "DQA0120", "PID-7"),
	...
	PatientNameHasJunkName(IssueObject.PATIENT, IssueType.HAS_JUNK_NAME, IssueField.PATIENT_NAME,"", SeverityLevel.ERROR, "102", "DQA0173", "PID-5"), 
	PatientNameFirstIsInvalid(IssueObject.PATIENT, IssueType.INVALID, IssueField.PATIENT_NAME_FIRST, "", SeverityLevel.ACCEPT, "102", "DQA0140", "PID-5.2"),
	PatientNameFirstIsMissing(IssueObject.PATIENT, IssueType.MISSING, IssueField.PATIENT_NAME_FIRST, "", SeverityLevel.ACCEPT, "101", "DQA0141", "PID-5.2"),
	...
	PatientNameLastIsInvalid(IssueObject.PATIENT, IssueType.INVALID, IssueField.PATIENT_NAME_LAST, "", SeverityLevel.ACCEPT, "102", "DQA0165", "PID-5.1"),
	PatientNameLastIsMissing(IssueObject.PATIENT, IssueType.MISSING, IssueField.PATIENT_NAME_LAST, "", SeverityLevel.ACCEPT, "101", "DQA0166", "PID-5.1"),
	PatientNameMiddleIsInvalid(IssueObject.PATIENT, IssueType.INVALID, IssueField.PATIENT_MIDDLE_NAME, "", SeverityLevel.ACCEPT, "", "DQA0528", ""),
	PatientNameMiddleIsMissing(IssueObject.PATIENT, IssueType.MISSING, IssueField.PATIENT_MIDDLE_NAME, "", SeverityLevel.ACCEPT, "", "DQA0529", ""),
	...
	PatientSubmitterIdIsMissing(IssueObject.PATIENT, IssueType.MISSING, IssueField.PATIENT_SUBMITTER_ID, "", SeverityLevel.ACCEPT, "101", "DQA0220", "PID-3"),
	...
	PatientSubmitterIdTypeCodeIsMissing(IssueObject.PATIENT, IssueType.MISSING, IssueField.PATIENT_SUBMITTER_ID_TYPE_CODE, "", SeverityLevel.WARN, "101", "DQA0394", "PID-3.5"),
	...
	PatientSubmitterIdTypeCodeIsInvalid(IssueObject.PATIENT, IssueType.INVALID, IssueField.PATIENT_SUBMITTER_ID_TYPE_CODE, "", SeverityLevel.ACCEPT, "", "DQA0513", ""),
	PatientSubmitterIdTypeCodeIsUnrecognized(IssueObject.PATIENT, IssueType.UNRECOGNIZED, IssueField.PATIENT_SUBMITTER_ID_TYPE_CODE, "", SeverityLevel.ACCEPT, "", "DQA0514", ""),
	...
	VaccinationAdminCodeIsInvalid(IssueObject.VACCINATION, IssueType.INVALID, IssueField.VACCINATION_ADMIN_CODE, "", SeverityLevel.ACCEPT, "102", "DQA0243", "RXA-5"),
	VaccinationAdminCodeIsInvalidForDateAdministered(IssueObject.VACCINATION, IssueType.INVALID_FOR_DATE_ADMINISTERED, IssueField.VACCINATION_ADMIN_CODE, "", SeverityLevel.ACCEPT, "102", "DQA0491", "RXA-5"),
	VaccinationAdminCodeIsMissing(IssueObject.VACCINATION, IssueType.MISSING, IssueField.VACCINATION_ADMIN_CODE, "", SeverityLevel.ACCEPT, "101", "DQA0244", "RXA-5"),
	...
	VaccinationAdminCodeIsNotVaccine(IssueObject.VACCINATION, IssueType.NOT_VACCINE, IssueField.VACCINATION_ADMIN_CODE, "", SeverityLevel.WARN, "102", "DQA0246", "RXA-5"),
	...
	VaccinationAdminCodeIsUnrecognized(IssueObject.VACCINATION, IssueType.UNRECOGNIZED, IssueField.VACCINATION_ADMIN_CODE, "", SeverityLevel.ACCEPT, "103", "DQA0247", "RXA-5"),
	VaccinationAdminCodeIsValuedAsNotAdministered(IssueObject.VACCINATION, IssueType.VALUED_AS, IssueField.VACCINATION_ADMIN_CODE, "not administered", SeverityLevel.INFO, "102", "DQA0248", "RXA-5"),
	...
	VaccinationAdminCodeTableIsMissing(IssueObject.VACCINATION, IssueType.MISSING, IssueField.VACCINATION_ADMIN_CODE_TABLE, "", SeverityLevel.WARN, "101", "DQA0483", "RXA-5"),
	VaccinationAdminCodeTableIsInvalid(IssueObject.VACCINATION, IssueType.INVALID, IssueField.VACCINATION_ADMIN_CODE_TABLE, "", SeverityLevel.WARN, "102", "DQA0484", "RXA-5"),
	...
	VaccinationAdminDateIsAfterPatientDeathDate(IssueObject.VACCINATION, IssueType.AFTER_PATIENT_DEATH_DATE, IssueField.VACCINATION_ADMIN_DATE, "", SeverityLevel.ACCEPT, "102", "DQA0253", "RXA-3"),
	VaccinationAdminDateIsAfterSystemEntryDate(IssueObject.VACCINATION, IssueType.AFTER_SYSTEM_ENTRY_DATE, IssueField.VACCINATION_ADMIN_DATE, "", SeverityLevel.ACCEPT, "102", "DQA0254", "RXA-3"),
	VaccinationAdminDateIsBeforeBirth(IssueObject.VACCINATION, IssueType.BEFORE_BIRTH, IssueField.VACCINATION_ADMIN_DATE, "", SeverityLevel.ACCEPT, "102", "DQA0255", "RXA-3"),
	...
	VaccinationAdminDateIsBeforeOrAfterLicensedVaccineRange(IssueObject.VACCINATION, IssueType.BEFORE_OR_AFTER_LICENSED_DATE_RANGE, IssueField.VACCINATION_ADMIN_DATE, "", SeverityLevel.ACCEPT, "102", "DQA0257", "RXA-3"),
	...
	VaccinationAdminDateIsBeforeOrAfterWhenValidForPatientAge(IssueObject.VACCINATION, IssueType.BEFORE_OR_AFTER_VALID_DATE_FOR_AGE, IssueField.VACCINATION_ADMIN_DATE, "", SeverityLevel.ACCEPT, "102", "DQA0259", "RXA-3"),
	VaccinationAdminDateIsInvalid(IssueObject.VACCINATION, IssueType.INVALID, IssueField.VACCINATION_ADMIN_DATE, "", SeverityLevel.ACCEPT, "102", "DQA0260", "RXA-3"),
	VaccinationAdminDateIsMissing(IssueObject.VACCINATION, IssueType.MISSING, IssueField.VACCINATION_ADMIN_DATE, "", SeverityLevel.ACCEPT, "101", "DQA0261", "RXA-3"),
	...
	VaccinationAdminDateIsReportedLate(IssueObject.VACCINATION, IssueType.REPORTED_LATE, IssueField.VACCINATION_ADMIN_DATE, "", SeverityLevel.WARN, "102", "DQA0265", "RXA-3"),
	...
	VaccinationAdministeredCodeIsForiegn(IssueObject.VACCINATION, IssueType.VALUED_AS, IssueField.VACCINATION_ADMIN_CODE, "foreign", SeverityLevel.WARN, "102", "DQA0268", "?"),
	VaccinationHistoricalCodeIsForeign(IssueObject.VACCINATION, IssueType.VALUED_AS, IssueField.VACCINATION_ADMIN_CODE, "foreign", SeverityLevel.WARN,  "102", "DQA0268", "?"),
