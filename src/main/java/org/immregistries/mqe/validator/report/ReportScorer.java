...
public enum ReportScorer {
  ...
  private MqeMessageService vlad = MqeMessageService.INSTANCE;
  ...
  public VxuScoredReport getDefaultReportForMessage(String vxuText) {
    MqeMessageMetrics metrics = getMqeMetricsFor(vxuText);
    return getDefaultReportForMetrics(metrics);
  }

  public VxuScoredReport getDefaultReportForMetrics(MqeMessageMetrics metrics) {
    return getScoredReport(this.defaultDef, metrics);
  }

  public MqeMessageMetrics getMqeMetricsFor(String vxuText) {
    MqeMessageServiceResponse response = vlad.processMessage(vxuText);
    MqeMessageMetrics msgMetrics = getMqeMetricsFor(response);
    return msgMetrics;
  }

  public MqeMessageMetrics getMqeMetricsFor(MqeMessageServiceResponse validationResults) {
    MqeMessageMetrics msgMetrics = eval.toMetrics(validationResults);
  ...
  protected VxuCompletenessSectionScore evaluateCompletenessSection(
      ReportCompletenessSectionDefinition section, MqeMessageMetrics measures) {
    ...
    List<MqeReportFieldDefinition> fields = section.getReportFields();

    for (MqeReportFieldDefinition d : fields) {
  ...
  protected List<FieldIssueScore> scoreIssues(MqeReportFieldDefinition definition,
